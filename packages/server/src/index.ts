...
const startServer = async () => {
  ...
  process.stdout.write(chalk.yellow(`\t+ ${chalk.white('Creating database connection ...')}`));
  await createConnection();
  console.log(chalk.green.bold('DONE'));

  process.stdout.write(chalk.yellow(`\t+ ${chalk.white('Creating express app ...')}`));
  const app = express();
  console.log(chalk.green.bold('DONE'));

  process.stdout.write(chalk.yellow(`\t+ ${chalk.white('Creating redis client instance ...')}`));
  const redis = new Redis();
  console.log(chalk.green.bold('DONE'))

  process.stdout.write(chalk.yellow(`\t+ ${chalk.white('Creating apollo server instance ...')}`));
  ...
  process.stdout.write(chalk.yellow(`\t+ ${chalk.white('Applying middleware to ApolloServer ...')}`))
